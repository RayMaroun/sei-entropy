# 4. Lab:  Dentist Website \(Solution\)
...
* This goes _in place of_ your existing component calls of `<Home />` or `<Home></Home>` \(depending on which syntax you went for\).
    ...
    return (
      <Router>
        <div className="app">
          ...
          <Route path="/procedure" component={Procedures} />
        </div>
      </Router>
    );
  }
