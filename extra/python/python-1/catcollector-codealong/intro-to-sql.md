...
**Go to this link and install it from the website** [PostgreSQL ](https://www.postgresql.org/download/)

Once that is complete go to one of the following links to view your databases in a GUI:

**MacOS**: [Postico](https://eggerapps.at/postico/)
...
* type `\?` to view a list of all commands
...
Connect to the database: `\c testdb`
